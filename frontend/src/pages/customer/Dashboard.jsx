                ...
                <div style={{ position: 'relative', height: '220px', background: '#F0EBE1', overflow: 'hidden' }}>
                  {product.image ? (
                    <img
                      src={product.image}
                      alt={product.name}
                      style={{ width: '100%', height: '100%', objectFit: 'contain', transition: 'transform 0.4s ease', padding: '10px' }}
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginTop: '14px' }}>
                    <button
                      ...
                      style={{
                        ...
                        color: isOutOfStock ? '#BBB' : 'var(--text-main)',
                        border: '1.5px solid var(--border-cohesive)',
                        borderRadius: '10px',
                        fontWeight: '800',
                        fontSize: '0.8rem',
                      ...
                      onMouseEnter={e => { if (!isOutOfStock) { e.currentTarget.style.background = '#FFF'; e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.color = 'var(--primary)'; } }}
                      onMouseLeave={e => { e.currentTarget.style.background = 'rgba(0,0,0,0.03)'; e.currentTarget.style.borderColor = 'var(--border-cohesive)'; e.currentTarget.style.color = 'var(--text-main)'; }}
                    >
                      {isOutOfStock ? 'Empty' : 'Add to Cart'}
                    </button>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
